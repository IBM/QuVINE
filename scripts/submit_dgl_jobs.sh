...
#
# Usage:
#   bash scripts/submit_dgl_jobs.sh [--dry-run]
...
DATA_ROOT="/dccstor/cgq4hls/Q/dgl/processed"
HPARAM_BASE="/dccstor/boseukb/Q/NetMed/QuVINE/results/hparam_tuning"
OUTPUT_BASE="/dccstor/cgq4hls/Q/dgl/results"
...
echo "======================================================"
echo " DGL Dataset Job Submission"
echo "======================================================"
...
print(f'Dataset: {graph_metadata.get("dataset_name", "dgl")}')
print(f'Type: {graph_metadata.get("type", "dgl_subsample")}')
...
analysis_metadata = {
    'type': graph_metadata.get('type', 'dgl_subsample'),
    'graph_name': GRAPH_NAME,
...
AGG_NAME="dgl_${SIZE_TAG}_aggregate"
