...
from qune.data.data_loader import load_graph, load_gwas_data
from qune.data.preprocess import build_subgraph, sparsify_with_connectivity

from qune.views.views import ViewBuilder
from qune.walks.base import BaseWalker
from qune.corpus.builder import CorpusBuilder
from qune.embedding.word2vec import corpus_to_embedding
from qune.embedding.registry import EmbeddingStore
from qune.analysis.compare import compare_embeddings
from qune.analysis.analyze import *
from qune.baselines import run_node2vec
from qune.fusion.fuse import fuse_embeddings
from qune.fusion.diagnostics import analyze_fusion
from qune.evaluation.ranking import (
    seed_centroid_scores,
    max_seed_cosine_scores,
    evaluate_embeddings_ranking
    )   
#from qune.evals.ranking import evaluate_ranking
# from utils.io import save_embeddings, save_metadata 
from qune.utils.seed import set_global_seed
from qune.utils.utilities import *

class Pipeline: 
    """
    End-to-end qune pipeline. 
    ...
    def run(self): 
        ...
        ranking_df, comparison_df, fusion_df = self._post_process(res)
    ...
    def _run_walks_for_root(self, graph_data, root, views): 
        ...
        walker = BaseWalker(self.cfg.walks.walker)
    ...
    def _post_process(all_results):
        
        ranking_dfs = [r["ranking_df"] for r in all_results]
